                ...
                Invite.create(invite)
                    .then(data => {
                        ...
                        const mailOptions = {
                            ...
                            html: '<p>Vous avez été invité par ' + userFrom.first_name + ' ' + userFrom.last_name + ' à rejoindre l\'espace ' + place.name + '. <a href="http://localhost:3001/invite/accept/' + data.id + '/' + token + '" target="_blank">Clickez ici pour le rejoindre</a>.</p>',
                        };
